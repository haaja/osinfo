...
class OSInfo():
    ...
    def print_info(self):
        ...
        info = {}
        info['uptime'] = "Uptime: " + self.get_uptime()
        info['kernel'] = "Kernel: " + self.get_kernel_version()
        info['host'] = "Hostname: " + self.get_hostname()
        info['distro'] = "Distribution: " + self.get_distribution_name()
        info['user'] = "User: " + self.get_username()
        info['load'] = "Loadavg: " + self.get_loadavg()
        info['reso'] = "Resolution: " + self.get_resolution()
        info['pkgs'] = "Installed packages: " \
            + self.get_number_of_installed_packages()
